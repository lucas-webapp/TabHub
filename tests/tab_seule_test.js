...
//     mute, déjà 100% relatifs à la TAB) ; les hampes rejoignent une ANCRE commune juste au-dessus
//     (voix seule/voix 0) ou en dessous (voix 1, deux voix) de la TAB, jamais une hauteur réelle qui
//     n'existe plus ; la signature rythmique reste affichée (le rythme se lit toujours par rapport à
//     un chiffrage) ; la page RÉTRÉCIT (l'espace d'une portée à 5 lignes n'est plus réservé) ;
